...
<body>
    <div class="calculator">
        <form method="post">
            ...
            <button type="submit" name="operator" value="/">/</button>
            <br>
            <button type="submit" name="plus_minus" value="plus_minus">+/-</button>
            <button type="submit" name="clear" value="clear">Del</button>
            <button type="submit" name="calculate" value="calculate" class="double-width">=</button>
        </form>
        {% if result is defined %}
        <h3>Outcome: {{ result }}</h3>
        {% endif %}
...
def handle_calculator():
    ...
    if request.method == 'POST':
        ...
        if 'digit' in request.form:
            ...
            expression += request.form['operator']
        elif 'plus_minus' in request.form:
